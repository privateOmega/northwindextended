...
--
-- Name: fk_customercustomerdemo; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY customercustomerdemo ADD CONSTRAINT fk_customercustomerdemo 
    FOREIGN KEY ("CustomerTypeID") REFERENCES customerdemographics ("CustomerTypeID");


--
-- Name: fk_customercustomerdemo_customers; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY customercustomerdemo ADD CONSTRAINT fk_customercustomerdemo_customers 
    FOREIGN KEY ("CustomerID") REFERENCES customers ("CustomerID");


--
-- Name: fk_employees_employees; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY employees ADD CONSTRAINT fk_employees_employees 
    FOREIGN KEY ("ReportsTo") REFERENCES employees ("EmployeeID");


--
-- Name: fk_employeeterritories_employees; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY employeeterritories ADD CONSTRAINT fk_employeeterritories_employees 
    FOREIGN KEY ("EmployeeID") REFERENCES employees ("EmployeeID");


--
-- Name: fk_employeeterritories_territories; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY employeeterritories ADD CONSTRAINT fk_employeeterritories_territories 
    FOREIGN KEY ("TerritoryID") REFERENCES territories ("TerritoryID");


--
-- Name: fk_order_details_orders; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY order_details ADD CONSTRAINT fk_order_details_orders 
    FOREIGN KEY ("OrderID") REFERENCES orders ("OrderID");


--
-- Name: fk_order_details_products; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY order_details ADD CONSTRAINT fk_order_details_products 
    FOREIGN KEY ("ProductID") REFERENCES products ("ProductID");


--
-- Name: fk_orders_customers; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY orders ADD CONSTRAINT fk_orders_customers 
    FOREIGN KEY ("CustomerID") REFERENCES customers ("CustomerID");


--
-- Name: fk_orders_employees; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY orders ADD CONSTRAINT fk_orders_employees 
    FOREIGN KEY ("EmployeeID") REFERENCES employees ("EmployeeID");


--
-- Name: fk_orders_shippers; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY orders ADD CONSTRAINT fk_orders_shippers 
...
ALTER TABLE ONLY products ADD CONSTRAINT fk_products_categories 
    FOREIGN KEY ("CategoryID") REFERENCES categories ("CategoryID");


--
-- Name: fk_products_suppliers; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY products ADD CONSTRAINT fk_products_suppliers 
    FOREIGN KEY ("SupplierID") REFERENCES suppliers ("SupplierID");


--
-- Name: fk_territories_region; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY territories ADD CONSTRAINT fk_territories_region 
